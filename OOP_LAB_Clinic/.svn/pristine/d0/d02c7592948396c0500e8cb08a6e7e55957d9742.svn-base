...
//		Pattern p = Pattern.compile("(P)([ ;]+)([A-Za-z0-9]+)([ ;]+)([A-Za-z0-9]+)([ ;]+)([A-Za-z0-9]+)");
//		Pattern d = Pattern.compile("(M)([ ;]+)([0-9]+)([ ;]+)([A-Za-z0-9]+)([ ;]+)([A-Za-z0-9]+)([ ;]+)([A-Za-z0-9]+)([ ;]+)([A-Za-z0-9]+)");
//		
//		Matcher m = null;
//		
//		m = p.matcher("P; 123; qqq; qqqq");
//		if(m.matches()) {
